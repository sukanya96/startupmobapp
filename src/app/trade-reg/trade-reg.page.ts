...
@Component({
  selector: 'app-trade-reg',
  templateUrl: './trade-reg.page.html',
  styleUrls: ['./trade-reg.page.scss'],
})
export class TradeRegPage implements OnInit {
  ...
  toggleGroup13(group) {
   ...
   isGroupShown14(group) {
    return this.shownGroup14 === group;
  };


  toggleGroup14(group) {
    if (this.isGroupShown14(group)) {
        this.shownGroup14 = null;
      } else {
        this.shownGroup14 = group;
      }
   };
